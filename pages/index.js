...
function Index8() {
  ...
  useEffect(() => {
    if (newProperties.length === 0) {
      ...
      axios
        .get(
          "https://testerp1apis.nextsolutions.in/api/properties?page=1&limit=10"
        )
        .then((e) => {
          console.log(e.data.data,1234151)
          // setProperties(e.data.data);
          setProperties(e?.data.data);
          setCheck(true);
        })
        .catch((e) => {});
        ...
        <div className="section-box mt-20 ">
          ...
          <a>
            ...
            <div className="absolute">
              ...
              <div className="w-[100%] h-[40px] mt-[50px] flex items-center justify-center" >
                <div onClick={()=>{

                   axios
                   .get(
                     `https://testerp1apis.nextsolutions.in/api/properties?page=1&limit=${newProperties.length+10}`
                   )
                   .then((e) => {
                     console.log(e.data.data,1234151)
                     // setProperties(e.data.data);
                   ...
                   .catch((e) => {});
                }} className="w-[100px] cursor-pointer font-sans font-medium rounded-[4px]  h-[40px] bg-[#006D77] text-white flex items-center justify-center" >
                  Load More
                </div>
              </div>
              {/* Old Style END */}
