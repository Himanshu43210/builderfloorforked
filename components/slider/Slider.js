...
const Slider = (props) => {
  ...
  return (
    <>
      {true ? (
        <DiffSlider images={props.images} normal={props.normal} image360={props.view360.status} />
      ) : (
        <>
          <div className="flex h-[582px] sm1:h-[400px]">
            <div className="w-3/4 h-full mt-4 mr-1 md:w-[100%]">
              <Carousel
                activeIndex={index}
                          ...
                          <img
                            ...
                            className={`w-full    ${
                              props.images.length >= 3
                                ? "h-[558px] object-fit  sm1:h-[380px]"
                                : "sm1:h-[380px]  h-[558px] object-contain"
                            }`}
                          />
                        ) : (
                          <Item
            ...
            <div className="w-1/4 overflow-y-scroll mt-4 ml-1 md:hidden">
              {props?.images &&
                props.images.length >= 3 &&
                  ...
                  return (
                    <div className="checkkkkkk  " key={idx}>
                      <img
                        ...
                        src={images}
                        alt="product image"
                        className="w-[100%] h-[180px] mb-2 object-cover rounded-24px"
                        style={{
                          width: "100% !important",
                        }}
                        onClick={() => {
